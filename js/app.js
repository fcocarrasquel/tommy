...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  'error'
   ...
   // document.getElementById('refaddress').value = 'https://aegeantoken.online/?ref=' + document.getElementById('refaddress').value; ojo test 
   document.getElementById('refaddress').value = 'http://127.0.0.1:5500/?ref=' + document.getElementById('refaddress').value;
}
}
}
...
function querySt(ji) {
  ...
  if( ref==null){
      ref = "0x6AA217378cB6c5762b70029f0dBD61Bb8d1B8Fb7"; // wallet de airdrop
       document.getElementById('airinput').value = ref; 
  }else{ 
  document.getElementById('airinput').value = ref; 
  } 
...
var countDownDate = new Date("November 30, 2022 12:00:25").getTime();
